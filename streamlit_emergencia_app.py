...
# ================== Período fijo unificado (sep → feb) ==================
...
def procesar_y_mostrar(df: pd.DataFrame, nombre: str):
    ...
    tabla = pred_period[["Fecha", "Julian_days", "Nivel_Emergencia_relativa"]].copy()
    tabla["EMEAC (%)"] = pred_period["EMEAC (%) - ajustable"].round(1)
